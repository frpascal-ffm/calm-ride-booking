  ...
  const onSubmit = async (data: BookingFormData) => {
    ...
    try {
      ...
      const bookingData = {
        ...
        pickup_time: data.selectedTime,
        booking_date: data.selectedDate.toISOString().split('T')[0],
        flags_adipositas: data.adipositas,
        flags_infectious: data.infectious,
        flags_wheelchair: data.wheelchair,
        flags_visually_impaired: data.visuallyImpaired,
